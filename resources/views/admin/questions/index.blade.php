@extends('layouts.admin', [
  'page_header' => 'Konu Bazında Sorular',
  'dash' => '',
  'quiz' => '',
  'users' => '',
  'questions' => 'active',
      ...
      @foreach ($topics as $key => $topic)
        <div class="col-md-4">
          <div class="quiz-card">
            ...
            <a href="{{route('questions.show', $topic->id)}}" class="btn btn-wave">Soruları Ekle</a>
            <a data-target="#deleteans{{ $topic->id }}" data-toggle="modal" class="btn btn-danger">Cevap Sayfasını Sil</a>
          </div>
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                          ...
                          <p>Bu Quiz Cevap Sayfasını gerçekten silmek istiyor musunuz? Bu işlem geri alınamaz.</p>
                        </div>

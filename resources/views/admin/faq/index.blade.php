@extends('layouts.admin', [
  'page_header' => 'SSS (Sıkça Sorulan Sorular)',
  'dash' => '',
  'quiz' => 'active',
  'users' => '',
  'questions' => '',
...
<div class="box">
    <div class="box-body">
      <!-- Modalı tetikleyen düğme -->
      <div class="margin-bottom">
      <a href="{{ route('faq.add') }}" class="btn btn-md btn-primary">+ SSS Oluştur</a>
            ...
            <tr>
              ...
              <td>
                <form method="POST" action="{{ route('faq.delete',$faq->id) }}">
                  {{ method_field('DELETE') }}
                  {{ csrf_field() }}
                  <button onclick="return confirm('Bu satırı SİLMEK istediğinizden emin misiniz?')" type="submit" class="btn btn-sm btn-danger">

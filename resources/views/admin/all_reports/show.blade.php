@extends('layouts.admin', [
  'page_header' => "En İyi Öğrenciler / {$topic->title}",
  'dash' => '',
  'quiz' => '',
  'users' => '',
  'questions' => '',
          ...
          @if ($answers)
            @foreach ($filtStudents as $key => $student)
              <tr>
                ...
                <td>
                  <a data-toggle="modal" data-target="#delete{{ $topic->id }}" title="Bu öğrencinin cevap kağıdını sıfırlayacak" href="#" class="btn btn-sm btn-warning">
                    Yanıtı Sıfırla
                  </a>

      ...
      ?>
       @if(!empty($users))
          <div class="alert alert-danger">
            Testi zaten verdiniz! Başka Sınavlar vermeye çalışın
          </div>
       @else
     ...
     $(document).ready(function() {
      ...
      setTimeout(function() {
          ...
          $(".nextbtn").click(function() {
              ...
              $(e).removeClass("active"), 0 == $(e).next().length ? (Cookies.remove("time"), Cookies.set("done", "Sınavınız Bitti...!", {
                  expires: 1
      ...
      if (Cookies.get("time") && Cookies.get("topic_id") == topic_id) {
          ...
          $("#clock").countdown(n, {
              ...
              var i = $(this);
              e.elapsed ? (Cookies.set("done", "Sınavınız Bitti...!", {
                  expires: 1
